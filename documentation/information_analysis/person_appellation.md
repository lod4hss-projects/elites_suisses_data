...
see here the [SQL scripts](../database_inspection/person_appellation.sql).
...
The transformation script is documented [here](../database_inspection/person_appellation.sql).
