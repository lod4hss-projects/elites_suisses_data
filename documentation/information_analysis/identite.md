...
| naissance | Date of birth (with a lot of inconsistencies) | [Person Birth and Death](../information_analysis/person_birth-death.md) |
| mort | Date of death (with a lot of inconsistencies) | [Person Birth and Death](../information_analysis/person_birth-death.md) |
| nbrMandats | String. This should be calculated | Not documented (calculated if needed) |
| cantonNaissance | The canton in code ("XY"), with "Étranger" when outside of Switzerland | [Person Birth and Death](../information_analysis/person_birth-death.md) and [t_geo_place](../information_analysis/t_geo_place.md) |
...
| lieuNaissance | The place of birth | [Person Birth and Death](../information_analysis/person_birth-death.md) and [t_geo_place](../information_analysis/t_geo_place.md) |
