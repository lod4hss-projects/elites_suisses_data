...
Regarding entity types cf. [this page](../database_inspection/groups_entities_types.sql).
...
## Second level not explicitely identified organisations


The queries on the last part of [this document](../database_inspection/groups_entities_exploration.sql) -> "Issue with organisations that cover different organisations-groups" show that serveral political entities, like parlaments and governements of cantons, are not explicitely defined but just appear in the *organe* column of the mandates table.

&nbsp;

It was therefore necessary to create a new table to identify organisations: the *sdh_group* table.

All of the *entites* table were imported into the *sdh_group* table
